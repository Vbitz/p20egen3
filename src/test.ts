import { Service, InternalServiceAction, SessionCreateData } from "./Service";
...
async function main(args: string[]): Promise<never> {
    ...
    let actions = sessionRequest.actions;

    let running: boolean = true;

    const question = function (question: string): Promise<string> {
